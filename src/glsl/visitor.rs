...
//!
//! ```
//! use shader_crusher::glsl::syntax::{CompoundStatement, Expr, SingleDeclaration, Statement, TypeSpecifierNonArray};
//! use shader_crusher::glsl::visitor::{Host, Visit, Visitor};
...
//! ```
//!
//! [`Host`]: crate::glsl::visitor::Host
//! [`Host::visit`]: crate::glsl::visitor::Host::visit
//! [`Visitor`]: crate::glsl::visitor::Visitor
