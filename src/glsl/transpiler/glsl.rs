...
//! [`Write`]: std::fmt::Write
//! [`show_translation_unit`]: crate::glsl::transpiler::glsl::show_translation_unit
//! [`syntax`]: crate::glsl::syntax
//! [`transpiler`]: crate::glsl::transpiler
...
mod tests {
  ...
  #[test]
  fn test_parentheses() {
    use crate::glsl::parsers::function_definition;
...
"#;
  ...
  #[test]
  fn test_do_while() {
    use crate::glsl::parsers::iteration_statement;
